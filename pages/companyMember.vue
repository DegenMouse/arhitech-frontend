    ...
    <div class="w-full max-w-lg">
      <div class="text-center">
        <div class="bg-white rounded-xl shadow-lg p-8">
          <h2 class="text-3xl font-bold text-gray-800 mb-4">Company Member Panel</h2>
          <p class="text-gray-600 mb-6">Welcome to the member dashboard for {{ company.companyName }}</p>
