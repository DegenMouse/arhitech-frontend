...
<template>
  ...
  <div class="w-72 h-screen bg-white border-r border-gray-100 flex flex-col shadow-sm">
    ...
    <nav class="flex-1 p-4 space-y-2">
      ...
      <NuxtLink to="/dashboard" 
        ...
        :class="$route.path === '/dashboard' 
          ...
          : 'text-gray-700 hover:bg-gray-50 hover:text-[#0743ae]'">
      ...
      <NuxtLink to="/projects" 
        class="flex items-center space-x-3 p-3 rounded-xl transition-all duration-100 group"
        :class="$route.path.startsWith('/projects') || $route.path.startsWith('/project/') 
          ? 'bg-[#0743ae]/10 text-[#0743ae] border border-[#0743ae]/20' 
          : 'text-gray-700 hover:bg-gray-50 hover:text-[#0743ae]'">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="p-4 border-t border-gray-100">
      ...
      <button 
        ...
        class="w-full p-4 text-left hover:bg-gray-50 rounded-xl transition-all duration-100 flex items-center space-x-3 group">
      ...
      <div v-if="toggleMenu && auth.isLoggedIn" 
        ...
        <NuxtLink to="/account" 
                  class="flex items-center space-x-3 w-full p-3 text-left hover:bg-gray-50 transition-colors duration-100">
        ...
        <!-- Logout button -->
        <button @click="logout" 
                class="flex items-center space-x-3 w-full p-3 text-left hover:bg-red-50 transition-colors duration-100 border-t border-gray-100">
