...
<template>
  ...
  <div class="w-72 h-screen bg-gray-50 border-r-2 border-gray-400 flex flex-col shadow-sm">
    ...
    <nav class="flex-1 p-4 space-y-2">
      ...
      <NuxtLink to="/dashboard" 
        ...
        :class="$route.path === '/dashboard' 
          ? 'bg-[#0743ae]/10 text-[#0743ae] border-2 border-[#0743ae]/40' 
    ...
    <div class="p-4 border-t-2 border-gray-400">
      ...
      <div v-if="toggleMenu && auth.isLoggedIn" 
           class="mt-2 bg-gray-50 border-2 border-gray-400 rounded-xl shadow-sm overflow-hidden">
        ...
        <!-- Logout button -->
        <button @click="logout" 
                class="flex items-center space-x-3 w-full p-3 text-left hover:bg-red-50 transition-colors duration-100 border-t-2 border-gray-400">
